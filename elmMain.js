...
var $author$project$Types$Text_ = function (a) {
	return {$: 'Text_', a: a};
};
...
var $author$project$Paragraphs$kingJohnDesc = $author$project$Types$Html_(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Achieved 3 A-Levels in Further Maths, Physics and Maths, with Grades of A* and A. Achieved a BTEC Level 3 National Extended Certificate in Computing, with a Grade of Distinction*')
				])),
...
var $author$project$Paragraphs$sotonDesc = $author$project$Types$Html_(
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Modules including Software Engineering Group Project, Advanced Programming Language Concepts, Machine Learning Technologies, Advanced Databases, and Automated Software Verification')
				])),
			A2($elm$html$Html$br, _List_Nil, _List_Nil),
			A2(
			$elm$html$Html$div,
