...
var $author$project$Types$GotWebsiteData = function (a) {
	return {$: 'GotWebsiteData', a: a};
};
var $author$project$JSONDecoder$WebsiteData = F3(
	function (career, projects, education) {
		return {career: career, education: education, projects: projects};
	});
var $author$project$JSONDecoder$Career = F5(
	function (role, company, date, skills, description) {
		return {company: company, date: date, description: description, role: role, skills: skills};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map5 = _Json_map5;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$JSONDecoder$careerDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$JSONDecoder$Career,
	...
	A2(
		...
		'description',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$JSONDecoder$Education = F4(
	function (school, accreditation, date, description) {
		return {accreditation: accreditation, date: date, description: description, school: school};
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$JSONDecoder$educationDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$JSONDecoder$Education,
	A2($elm$json$Json$Decode$field, 'school', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'accreditation', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'date', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
		'description',
...
var $author$project$JSONDecoder$Project = F4(
	function (role, date, skills, description) {
		return {date: date, description: description, role: role, skills: skills};
	});
var $author$project$JSONDecoder$projectDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$JSONDecoder$Project,
	A2($elm$json$Json$Decode$field, 'role', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'date', $elm$json$Json$Decode$string),
	A2(
		$elm$json$Json$Decode$field,
	...
	A2(
		...
		'description',
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string)));
var $author$project$JSONDecoder$dataDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$JSONDecoder$WebsiteData,
	A2(
		$elm$json$Json$Decode$field,
		'career',
		$elm$json$Json$Decode$list($author$project$JSONDecoder$careerDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'projects',
		$elm$json$Json$Decode$list($author$project$JSONDecoder$projectDecoder)),
	A2(
		$elm$json$Json$Decode$field,
		'education',
		$elm$json$Json$Decode$list($author$project$JSONDecoder$educationDecoder)));
...
var $author$project$Main$getWebsiteData = function (response) {
	if (response.$ === 'Success') {
		return $elm$core$Platform$Cmd$none;
	} else {
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Types$GotWebsiteData, $author$project$JSONDecoder$dataDecoder),
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{darkmode: true, httpResponse: $author$project$Types$Loading, positions: $elm$core$Maybe$Nothing, viewport: $elm$core$Maybe$Nothing},
		$author$project$Main$getWebsiteData($author$project$Types$Loading));
};
var $author$project$Types$GetPositionUpdate = {$: 'GetPositionUpdate'};
var $author$project$Types$GetViewportUpdate = {$: 'GetViewportUpdate'};
var $author$project$Types$GetWebsiteDataUpdate = {$: 'GetWebsiteDataUpdate'};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				50,
				function (_v1) {
					return $author$project$Types$GetPositionUpdate;
				}),
				A2(
				$elm$time$Time$every,
				50,
				function (_v2) {
					return $author$project$Types$GetViewportUpdate;
				}),
				A2(
				$elm$time$Time$every,
				50,
				function (_v3) {
					return $author$project$Types$GetWebsiteDataUpdate;
				})
			]));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'GotPositions':
				var result = msg.a;
				if ((((result.$ === 'Ok') && result.a.b) && result.a.b.b) && (!result.a.b.b.b)) {
					var _v2 = result.a;
					var eProject = _v2.a;
					var _v3 = _v2.b;
					var eEducation = _v3.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								positions: $elm$core$Maybe$Just(
									_Utils_Tuple2(
										$elm$core$Basics$round(eProject.element.y),
										$elm$core$Basics$round(eEducation.element.y)))
							}),
						$elm$core$Platform$Cmd$none);
				} else {
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								httpResponse: $author$project$Types$Success(data)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{httpResponse: $author$project$Types$Failure}),
						$elm$core$Platform$Cmd$none);
				}
			case 'GetPositionUpdate':
				return _Utils_Tuple2(
					model,
					A2(
						$elm$core$Task$attempt,
						$author$project$Types$GotPositions,
						$elm$core$Task$sequence(
							_List_fromArray(
								[
			...
			case 'GetWebsiteDataUpdate':
				return _Utils_Tuple2(
					model,
					$author$project$Main$getWebsiteData(model.httpResponse));
			case 'GoTo':
				var section = msg.a;
				return _Utils_Tuple2(
					model,
							...
							case 'Projects':
								...
								if (_v7.$ === 'Nothing') {
									...
									return A2(
										...
										A2($elm$browser$Browser$Dom$setViewport, 0, i - 181));
								}
							default:
								var _v10 = model.positions;
								if (_v10.$ === 'Nothing') {
									return $elm$core$Platform$Cmd$none;
								} else {
									var _v11 = _v10.a;
...
var $author$project$Types$Java = {$: 'Java'};
var $author$project$Types$JavaScript = {$: 'JavaScript'};
...
var $author$project$Types$decodeSkills = function (skill) {
	switch (skill) {
		case 'ProgrammingLanguages':
			return $author$project$Types$ProgrammingLanguages;
		case 'Haskell':
			return $author$project$Types$Haskell;
		case 'WebDevelopment':
			return $author$project$Types$WebDevelopment;
		case 'Research':
			return $author$project$Types$Research;
		case 'React':
			return $author$project$Types$React;
		case 'JavaScript':
			return $author$project$Types$JavaScript;
		case 'Python':
			return $author$project$Types$Python;
		case 'Django':
			return $author$project$Types$Django;
		case 'Java':
			return $author$project$Types$Java;
		case 'HTML':
			return $author$project$Types$HTML;
		case 'CSS':
			return $author$project$Types$CSS;
		case 'ProjectManagement':
			return $author$project$Types$ProjectManagement;
		case 'AppDevelopment':
			return $author$project$Types$AppDevelopment;
		case 'Kotlin':
			return $author$project$Types$Kotlin;
		case 'UI':
			return $author$project$Types$UI;
		case 'Database':
			return $author$project$Types$Database;
		case 'API':
			return $author$project$Types$API;
		default:
...
var $author$project$Main$getCurrentSection = function (model) {
	...
	if (!_v2.a) {
		if (!_v2.b) {
			...
			return $author$project$Types$Education;
		}
	} else {
		if (!_v2.b) {
			return $author$project$Types$Projects;
		} else {
			return $author$project$Types$Education;
		}
	}
...
var $author$project$Components$handleDescription = function (list) {
	if (!list.b) {
		return _List_Nil;
	} else {
		if (!list.b.b) {
			...
			return _Utils_ap(
				...
				$author$project$Components$handleDescription(xs));
		}
	}
};
...
var $author$project$Components$skillsBox = function (skill) {
	var _v0 = function () {
		switch (skill.$) {
			...
			default:
				return _Utils_Tuple2('background-accent', 'ERROR');
		}
	}();
				...
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Components$handleDescription(desc))
						]))
				]));
	});
...
var $author$project$Main$view = function (model) {
	...
	var _v0 = function () {
		var _v1 = model.httpResponse;
		if (_v1.$ === 'Success') {
			var data = _v1.a;
			return _Utils_Tuple3(data.career, data.projects, data.education);
		} else {
			return _Utils_Tuple3(_List_Nil, _List_Nil, _List_Nil);
		}
	}();
	var careerData = _v0.a;
	var projectData = _v0.b;
	var educationData = _v0.c;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
										...
										A2(
											...
											function (career) {
												return A5(
													...
													career.company,
													career.date,
													A2($elm$core$List$map, $author$project$Types$decodeSkills, career.skills),
													career.description);
											},
											careerData))
									])),
										...
										A2(
											...
											function (project) {
												return A4(
													...
													project.role,
													project.date,
													A2($elm$core$List$map, $author$project$Types$decodeSkills, project.skills),
													project.description);
											},
											projectData))
									])),
								...
								_List_fromArray(
									[
										...
										A2(
											$elm$core$List$map,
											function (education) {
												return A5($author$project$Components$timeLineBox, education.school, education.accreditation, education.date, _List_Nil, education.description);
											},
											educationData))
									]))
							]))
